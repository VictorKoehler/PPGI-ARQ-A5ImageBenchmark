...
Image3DMYXC::Image3DMYXC(uint width, uint height, uint channels) {
    init(width, height, channels);
}

Image3DMYXC::Image3DMYXC(const char *file, bool forceDefaultChannels) {
...
Image3DMYXC::~Image3DMYXC() {
    if (width*height*channels > 0)
        delete[] buff;
}


void Image3DMYXC::save(const char *const file) const {
